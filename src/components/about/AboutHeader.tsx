      ...
      <div className="pt-6 bg-gradient-to-r from-[#e8ecee] to-[#314c5e]">
        <div className="container px-3 m-4 flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            We are a tech-driven company focused on delivering innovative IT solutions. Our team is committed to helping businesses grow through reliable and cutting-edge services.
            </p>
          </div>
          {/* Right Col */}
